    ...
    <div className="font-['Inter'] bg-gray-50">
      ...
      <main className="bg-white pt-20 w-full">
        <div className="w-full max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-black mb-4 break-words">Your Gateway to Knowledge</p>
          <h1 className="text-6xl font-bold text-black mb-8 break-words">Learning Hub</h1>
          <p className="text-xl text-black mb-4 break-words">Your central platform for learning and development</p>
          <p className="text-xl text-black mb-8 break-words">Access courses, tools, and resources to enhance your skills</p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/learning-hub/courses" className="bg-black text-white px-6 py-3 rounded-full hover:bg-gray-800">
              Browse Courses →
            </Link>
            <Link href="/learning-hub/toolbase" className="border border-gray-300 px-6 py-3 rounded-full hover:bg-gray-100 text-black">
              Explore Tools
            </Link>
          </div>
        </div>
      ...
      {/* Rest of your content in a separate main section */}
      <main className="w-full max-w-7xl mx-auto py-12 px-4 pt-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <h2 className="text-xl font-semibold mb-2 text-black">Progress Tracking (Coming Soon!)</h2>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <h2 className="text-xl font-semibold mb-2 text-black">Interactive Learning (Coming Soon!)</h2>
