      ...
      <main className="pt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="max-w-2xl mx-auto">
            <h1 className="text-4xl font-bold text-black mb-8 text-center">Create Your Account</h1>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-black text-black">
              ...
              <p className="mt-6 text-center text-black">
                Already have an account? <Link href="/login" className="text-black underline hover:text-gray-800">Sign in</Link>
              </p>
            </div>
          </div>
        </div>
